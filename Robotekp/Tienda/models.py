...
class Producto(models.Model):
    ...
    Descripcion = models.CharField(db_column='Descripcion',max_length=100, blank=False, null=False)
    Precio_de_venta = models.IntegerField(db_column='Precio_de_venta', blank=False, null=False)
    URL_Video = models.CharField(db_column='URL_Video',max_length=250, blank=False, null=True)
    URL_Imagen = models.CharField(db_column='URL_Imagen',max_length=250, blank=False, null=True)
